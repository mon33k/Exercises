...
var office = new Room([desk, lamp, box, bookcase])
       var desk = new RoomObject([
            "Desk", 
            "Small wooden desk with one large drawer in the front",
            ['toothbrush', 'letter', 'pen',],
            "letter",
            ['show', 'examine', 'look', 'search']
        ]);
        var lamp = new RoomObject([
            'Lamp',
            'blue lamp with a light switch',
            ['light bulb', 'screw driver', 'soap'],
            "soap",
            ['show', 'examine', 'look', 'search']
        ]);
        var box = new RoomObject([
            'box',
            'plain blue shoe box',
            ['gun', 'key', 'water bottle'],
            'key',
            ['show', 'examine', 'look', 'search']
        ]);
        var bookcase = new RoomObject([
            'bookcase',
            'small wooden bookcase',
            ['Lord Of The Rings', 'Harry Potter Vol4', 'Star Trek', 'flashlight'],
            ['show', 'examine', 'look', 'search']
        ]);
        var door = new RoomObject([
            'door',
            'heavy steel door that is locked',
            ['lock', 'door knob'],
            "lock",
            ['show', 'examine', 'look', 'search']
        ]);
